...
export class QuickListsHomePage {
  ...
  constructor(private nav: NavController, public dataService: Data, public alertCtrl: AlertController) {
  ...
  renameChecklist(checklist):void{
    ...
    let prompt = this.alertCtrl.create({
      ...
      message: 'Enter the new name of the new checklist below',
      inputs:[
        {
          name:'name'
        }
  ...
  viewChecklist(checklist):void{
    ...
    this.nav.push(ChecklistPage,{checklist:checklist});
  }
